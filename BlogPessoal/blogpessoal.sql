...
-- -----------------------------------------------------
-- Table `db_blogpessoal`.`tb)usuarios`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `db_blogpessoal`.`tb)usuarios` (
  `id` BIGINT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `db_blogpessoal`.`tb_postagens` (
  ...
  INDEX `fk_tb_postagens_tb)usuarios1_idx` (`fk_usuarios_id` ASC) VISIBLE,
  CONSTRAINT `fk_tb_postagens_tb_temas`
    FOREIGN KEY (`fk_temas_id`)
    REFERENCES `db_blogpessoal`.`tb_temas` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_tb_postagens_tb)usuarios1`
    FOREIGN KEY (`fk_usuarios_id`)
    REFERENCES `db_blogpessoal`.`tb)usuarios` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
